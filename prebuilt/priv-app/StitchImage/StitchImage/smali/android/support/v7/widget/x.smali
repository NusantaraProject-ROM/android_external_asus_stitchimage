...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    invoke-static {p1}, Landroid/support/v7/widget/fa;->a(Landroid/content/Context;)Landroid/content/Context;
    ...
    invoke-direct {p1, p0}, Landroid/support/v7/widget/i;-><init>(Landroid/view/View;)V

    iput-object p1, p0, Landroid/support/v7/widget/x;->a:Landroid/support/v7/widget/i;

    iget-object p1, p0, Landroid/support/v7/widget/x;->a:Landroid/support/v7/widget/i;
    ...
    iput-object p1, p0, Landroid/support/v7/widget/x;->b:Landroid/support/v7/widget/w;

    iget-object p1, p0, Landroid/support/v7/widget/x;->b:Landroid/support/v7/widget/w;
...
.method private d()V
    ...
    iget-object v0, p0, Landroid/support/v7/widget/x;->c:Ljava/util/concurrent/Future;
    ...
    :try_start_0
    iput-object v1, p0, Landroid/support/v7/widget/x;->c:Ljava/util/concurrent/Future;

    invoke-interface {v0}, Ljava/util/concurrent/Future;->get()Ljava/lang/Object;

    move-result-object v0

    check-cast v0, La/c/c/e/a;

    invoke-static {p0, v0}, Landroid/support/v4/widget/l;->a(Landroid/widget/TextView;La/c/c/e/a;)V
    :try_end_0
...
.method protected drawableStateChanged()V
    ...
    iget-object v0, p0, Landroid/support/v7/widget/x;->a:Landroid/support/v7/widget/i;
    ...
    :cond_0
    iget-object v0, p0, Landroid/support/v7/widget/x;->b:Landroid/support/v7/widget/w;
...
.method public getTextMetricsParamsCompat()La/c/c/e/a$a;
    .locals 1

    invoke-static {p0}, Landroid/support/v4/widget/l;->c(Landroid/widget/TextView;)La/c/c/e/a$a;
...
.method public setPrecomputedText(La/c/c/e/a;)V
    .locals 0

    invoke-static {p0, p1}, Landroid/support/v4/widget/l;->a(Landroid/widget/TextView;La/c/c/e/a;)V
...
.method public setTextFuture(Ljava/util/concurrent/Future;)V
    ...
    iput-object p1, p0, Landroid/support/v7/widget/x;->c:Ljava/util/concurrent/Future;
...
.method public setTextMetricsParamsCompat(La/c/c/e/a$a;)V
    .locals 0

    invoke-static {p0, p1}, Landroid/support/v4/widget/l;->a(Landroid/widget/TextView;La/c/c/e/a$a;)V
