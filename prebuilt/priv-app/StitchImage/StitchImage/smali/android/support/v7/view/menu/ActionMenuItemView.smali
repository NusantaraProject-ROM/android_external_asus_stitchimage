...
# instance fields
.field d:Landroid/support/v7/view/menu/n;

.field private e:Ljava/lang/CharSequence;

.field private f:Landroid/graphics/drawable/Drawable;

.field g:Landroid/support/v7/view/menu/k$b;

.field private h:Landroid/support/v7/widget/E;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    sget-object v1, La/c/d/a/j;->ActionMenuItemView:[I
    ...
    sget p2, La/c/d/a/j;->ActionMenuItemView_android_minWidth:I
...
.method private f()V
    ...
    iget-object v2, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->d:Landroid/support/v7/view/menu/n;

    invoke-virtual {v2}, Landroid/support/v7/view/menu/n;->n()Z
    ...
    invoke-virtual {v2}, Landroid/support/v7/view/menu/n;->getContentDescription()Ljava/lang/CharSequence;
    ...
    invoke-virtual {v2}, Landroid/support/v7/view/menu/n;->getTitle()Ljava/lang/CharSequence;
    ...
    invoke-virtual {v2}, Landroid/support/v7/view/menu/n;->getTooltipText()Ljava/lang/CharSequence;
    ...
    :cond_5
    iget-object v0, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->d:Landroid/support/v7/view/menu/n;

    invoke-virtual {v0}, Landroid/support/v7/view/menu/n;->getTitle()Ljava/lang/CharSequence;

    move-result-object v1

    :goto_3
    invoke-static {p0, v1}, Landroid/support/v7/widget/pa;->a(Landroid/view/View;Ljava/lang/CharSequence;)V

    goto :goto_4

    :cond_6
    invoke-static {p0, v2}, Landroid/support/v7/widget/pa;->a(Landroid/view/View;Ljava/lang/CharSequence;)V
...
# virtual methods
.method public a(Landroid/support/v7/view/menu/n;I)V
    .locals 0

    iput-object p1, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->d:Landroid/support/v7/view/menu/n;

    invoke-virtual {p1}, Landroid/support/v7/view/menu/n;->getIcon()Landroid/graphics/drawable/Drawable;

    move-result-object p2

    invoke-virtual {p0, p2}, Landroid/support/v7/view/menu/ActionMenuItemView;->setIcon(Landroid/graphics/drawable/Drawable;)V

    invoke-virtual {p1, p0}, Landroid/support/v7/view/menu/n;->a(Landroid/support/v7/view/menu/u$a;)Ljava/lang/CharSequence;

    move-result-object p2

    invoke-virtual {p0, p2}, Landroid/support/v7/view/menu/ActionMenuItemView;->setTitle(Ljava/lang/CharSequence;)V

    invoke-virtual {p1}, Landroid/support/v7/view/menu/n;->getItemId()I

    move-result p2

    invoke-virtual {p0, p2}, Landroid/widget/TextView;->setId(I)V

    invoke-virtual {p1}, Landroid/support/v7/view/menu/n;->isVisible()Z
    ...
    iget-object p1, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->h:Landroid/support/v7/widget/E;
    ...
    iput-object p1, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->h:Landroid/support/v7/widget/E;
...
.method public b()Z
    ...
    invoke-virtual {v0}, Landroid/support/v7/view/menu/n;->getIcon()Landroid/graphics/drawable/Drawable;
...
.method public d()Z
    ...
    invoke-virtual {p0}, Landroid/support/v7/widget/x;->getText()Ljava/lang/CharSequence;
...
.method public getItemData()Landroid/support/v7/view/menu/n;
    .locals 1
...
.method public onClick(Landroid/view/View;)V
    ...
    iget-object p1, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->g:Landroid/support/v7/view/menu/k$b;

    if-eqz p1, :cond_0

    iget-object v0, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->d:Landroid/support/v7/view/menu/n;

    invoke-interface {p1, v0}, Landroid/support/v7/view/menu/k$b;->a(Landroid/support/v7/view/menu/n;)Z
...
.method public onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    invoke-virtual {v0}, Landroid/support/v7/view/menu/n;->hasSubMenu()Z

    move-result v0

    if-eqz v0, :cond_0

    iget-object v0, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->h:Landroid/support/v7/widget/E;
...
.method public setExpandedFormat(Z)V
    ...
    iget-object p1, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->d:Landroid/support/v7/view/menu/n;

    if-eqz p1, :cond_0

    invoke-virtual {p1}, Landroid/support/v7/view/menu/n;->b()V
...
.method public setItemInvoker(Landroid/support/v7/view/menu/k$b;)V
    ...
    iput-object p1, p0, Landroid/support/v7/view/menu/ActionMenuItemView;->g:Landroid/support/v7/view/menu/k$b;
