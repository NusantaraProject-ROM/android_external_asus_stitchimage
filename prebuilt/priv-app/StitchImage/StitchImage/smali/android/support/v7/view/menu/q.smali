.class abstract Landroid/support/v7/view/menu/q;
...
.method protected static b(Landroid/support/v7/view/menu/k;)Z
    ...
    invoke-virtual {p0, v2}, Landroid/support/v7/view/menu/k;->getItem(I)Landroid/view/MenuItem;
...
.method public a(Landroid/graphics/Rect;)V
    ...
    iput-object p1, p0, Landroid/support/v7/view/menu/q;->a:Landroid/graphics/Rect;
...
.method public f()Landroid/graphics/Rect;
    ...
    iget-object v0, p0, Landroid/support/v7/view/menu/q;->a:Landroid/graphics/Rect;
...
.method public onItemClick(Landroid/widget/AdapterView;Landroid/view/View;IJ)V
    ...
    invoke-static {p1}, Landroid/support/v7/view/menu/q;->a(Landroid/widget/ListAdapter;)Landroid/support/v7/view/menu/j;

    move-result-object p2

    iget-object p2, p2, Landroid/support/v7/view/menu/j;->a:Landroid/support/v7/view/menu/k;
    ...
    invoke-virtual {p0}, Landroid/support/v7/view/menu/q;->e()Z
    ...
    :goto_0
    invoke-virtual {p2, p1, p0, p3}, Landroid/support/v7/view/menu/k;->a(Landroid/view/MenuItem;Landroid/support/v7/view/menu/t;I)Z
