...
.field e:Landroid/support/v4/graphics/drawable/d$a;
...
.method constructor <init>(Landroid/graphics/drawable/Drawable;)V
    ...
    invoke-virtual {p0}, Landroid/support/v4/graphics/drawable/d;->c()Landroid/support/v4/graphics/drawable/d$a;

    move-result-object v0

    iput-object v0, p0, Landroid/support/v4/graphics/drawable/d;->e:Landroid/support/v4/graphics/drawable/d$a;
...
.method constructor <init>(Landroid/support/v4/graphics/drawable/d$a;Landroid/content/res/Resources;)V
    ...
    iput-object p1, p0, Landroid/support/v4/graphics/drawable/d;->e:Landroid/support/v4/graphics/drawable/d$a;
...
.method private a(Landroid/content/res/Resources;)V
    ...
    iget-object v0, p0, Landroid/support/v4/graphics/drawable/d;->e:Landroid/support/v4/graphics/drawable/d$a;
...
.method private a([I)Z
    ...
    iget-object v2, v0, Landroid/support/v4/graphics/drawable/d$a;->c:Landroid/content/res/ColorStateList;

    iget-object v0, v0, Landroid/support/v4/graphics/drawable/d$a;->d:Landroid/graphics/PorterDuff$Mode;
    ...
    iget-boolean v2, p0, Landroid/support/v4/graphics/drawable/d;->d:Z

    if-eqz v2, :cond_1

    iget v2, p0, Landroid/support/v4/graphics/drawable/d;->b:I

    if-ne p1, v2, :cond_1

    iget-object v2, p0, Landroid/support/v4/graphics/drawable/d;->c:Landroid/graphics/PorterDuff$Mode;
    ...
    iput p1, p0, Landroid/support/v4/graphics/drawable/d;->b:I

    iput-object v0, p0, Landroid/support/v4/graphics/drawable/d;->c:Landroid/graphics/PorterDuff$Mode;

    const/4 p1, 0x1

    iput-boolean p1, p0, Landroid/support/v4/graphics/drawable/d;->d:Z

    return p1

    :cond_2
    iput-boolean v1, p0, Landroid/support/v4/graphics/drawable/d;->d:Z
...
.method public final a(Landroid/graphics/drawable/Drawable;)V
    ...
    :cond_0
    iput-object p1, p0, Landroid/support/v4/graphics/drawable/d;->g:Landroid/graphics/drawable/Drawable;
...
.method public getChangingConfigurations()I
    ...
    iget-object v1, p0, Landroid/support/v4/graphics/drawable/d;->g:Landroid/graphics/drawable/Drawable;
...
.method public mutate()Landroid/graphics/drawable/Drawable;
    ...
    iput-boolean v0, p0, Landroid/support/v4/graphics/drawable/d;->f:Z
