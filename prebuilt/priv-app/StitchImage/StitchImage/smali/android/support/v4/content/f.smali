...
.method public static a(Landroid/content/Intent;)Z
    ...
    :try_start_0
    sget-object v1, Landroid/support/v4/content/f;->a:Landroid/util/SparseArray;
...
.method public static b(Landroid/content/Context;Landroid/content/Intent;)Landroid/content/ComponentName;
    ...
    :try_start_0
    sget v1, Landroid/support/v4/content/f;->b:I

    sget v2, Landroid/support/v4/content/f;->b:I

    const/4 v3, 0x1

    add-int/2addr v2, v3

    sput v2, Landroid/support/v4/content/f;->b:I

    sget v2, Landroid/support/v4/content/f;->b:I

    if-gtz v2, :cond_0

    sput v3, Landroid/support/v4/content/f;->b:I
