...
.method constructor <init>(Landroid/support/v4/app/W$c;)V
    ...
    iget-object v2, p1, Landroid/support/v4/app/W$c;->a:Landroid/content/Context;

    iget-object v3, p1, Landroid/support/v4/app/W$c;->I:Ljava/lang/String;
    ...
    iget-object v0, p1, Landroid/support/v4/app/W$c;->N:Landroid/app/Notification;

    iget-object v2, p0, Landroid/support/v4/app/X;->a:Landroid/app/Notification$Builder;
    ...
    iget-object v4, p1, Landroid/support/v4/app/W$c;->h:Landroid/widget/RemoteViews;
    ...
    iget-object v3, p1, Landroid/support/v4/app/W$c;->d:Ljava/lang/CharSequence;

    invoke-virtual {v2, v3}, Landroid/app/Notification$Builder;->setContentTitle(Ljava/lang/CharSequence;)Landroid/app/Notification$Builder;

    move-result-object v2

    iget-object v3, p1, Landroid/support/v4/app/W$c;->e:Ljava/lang/CharSequence;

    invoke-virtual {v2, v3}, Landroid/app/Notification$Builder;->setContentText(Ljava/lang/CharSequence;)Landroid/app/Notification$Builder;

    move-result-object v2

    iget-object v3, p1, Landroid/support/v4/app/W$c;->j:Ljava/lang/CharSequence;

    invoke-virtual {v2, v3}, Landroid/app/Notification$Builder;->setContentInfo(Ljava/lang/CharSequence;)Landroid/app/Notification$Builder;

    move-result-object v2

    iget-object v3, p1, Landroid/support/v4/app/W$c;->f:Landroid/app/PendingIntent;
    ...
    iget-object v3, p1, Landroid/support/v4/app/W$c;->g:Landroid/app/PendingIntent;
    ...
    iget-object v3, p1, Landroid/support/v4/app/W$c;->i:Landroid/graphics/Bitmap;

    invoke-virtual {v2, v3}, Landroid/app/Notification$Builder;->setLargeIcon(Landroid/graphics/Bitmap;)Landroid/app/Notification$Builder;

    move-result-object v2

    iget v3, p1, Landroid/support/v4/app/W$c;->k:I

    invoke-virtual {v2, v3}, Landroid/app/Notification$Builder;->setNumber(I)Landroid/app/Notification$Builder;

    move-result-object v2

    iget v3, p1, Landroid/support/v4/app/W$c;->r:I

    iget v7, p1, Landroid/support/v4/app/W$c;->s:I

    iget-boolean v8, p1, Landroid/support/v4/app/W$c;->t:Z
    ...
    iget-object v6, p1, Landroid/support/v4/app/W$c;->p:Ljava/lang/CharSequence;
    ...
    invoke-direct {p0, v6}, Landroid/support/v4/app/X;->a(Landroid/support/v4/app/W$a;)V

    goto :goto_5

    :cond_6
    iget-object v2, p1, Landroid/support/v4/app/W$c;->B:Landroid/os/Bundle;

    if-eqz v2, :cond_7

    iget-object v6, p0, Landroid/support/v4/app/X;->f:Landroid/os/Bundle;
    ...
    iget-boolean v2, p1, Landroid/support/v4/app/W$c;->x:Z

    if-eqz v2, :cond_8

    iget-object v2, p0, Landroid/support/v4/app/X;->f:Landroid/os/Bundle;
    ...
    :cond_8
    iget-object v2, p1, Landroid/support/v4/app/W$c;->u:Ljava/lang/String;
    ...
    iget-boolean v2, p1, Landroid/support/v4/app/W$c;->v:Z
    ...
    :cond_a
    iget-object v2, p1, Landroid/support/v4/app/W$c;->w:Ljava/lang/String;

    if-eqz v2, :cond_b

    iget-object v4, p0, Landroid/support/v4/app/X;->f:Landroid/os/Bundle;
    ...
    :cond_b
    iget-object v2, p1, Landroid/support/v4/app/W$c;->F:Landroid/widget/RemoteViews;

    iput-object v2, p0, Landroid/support/v4/app/X;->c:Landroid/widget/RemoteViews;

    iget-object v2, p1, Landroid/support/v4/app/W$c;->G:Landroid/widget/RemoteViews;

    iput-object v2, p0, Landroid/support/v4/app/X;->d:Landroid/widget/RemoteViews;
    ...
    iget-object v2, p1, Landroid/support/v4/app/W$c;->O:Ljava/util/ArrayList;
    ...
    iget-object v4, p1, Landroid/support/v4/app/W$c;->O:Ljava/util/ArrayList;
    ...
    iget-object v3, p1, Landroid/support/v4/app/W$c;->A:Ljava/lang/String;

    invoke-virtual {v2, v3}, Landroid/app/Notification$Builder;->setCategory(Ljava/lang/String;)Landroid/app/Notification$Builder;

    move-result-object v2

    iget v3, p1, Landroid/support/v4/app/W$c;->C:I

    invoke-virtual {v2, v3}, Landroid/app/Notification$Builder;->setColor(I)Landroid/app/Notification$Builder;

    move-result-object v2

    iget v3, p1, Landroid/support/v4/app/W$c;->D:I

    invoke-virtual {v2, v3}, Landroid/app/Notification$Builder;->setVisibility(I)Landroid/app/Notification$Builder;

    move-result-object v2

    iget-object v3, p1, Landroid/support/v4/app/W$c;->E:Landroid/app/Notification;
    ...
    iget-object v0, p1, Landroid/support/v4/app/W$c;->O:Ljava/util/ArrayList;
    ...
    :cond_f
    iget-object v0, p1, Landroid/support/v4/app/W$c;->H:Landroid/widget/RemoteViews;

    iput-object v0, p0, Landroid/support/v4/app/X;->h:Landroid/widget/RemoteViews;

    iget-object v0, p1, Landroid/support/v4/app/W$c;->c:Ljava/util/ArrayList;
    ...
    invoke-virtual {p1}, Landroid/support/v4/app/W$c;->b()Landroid/os/Bundle;
    ...
    :goto_8
    iget-object v6, p1, Landroid/support/v4/app/W$c;->c:Ljava/util/ArrayList;
    ...
    iget-object v7, p1, Landroid/support/v4/app/W$c;->c:Ljava/util/ArrayList;

    invoke-virtual {v7, v4}, Ljava/util/ArrayList;->get(I)Ljava/lang/Object;

    move-result-object v7

    check-cast v7, Landroid/support/v4/app/W$a;

    invoke-static {v7}, Landroid/support/v4/app/Y;->a(Landroid/support/v4/app/W$a;)Landroid/os/Bundle;
    ...
    iget-object v3, p0, Landroid/support/v4/app/X;->f:Landroid/os/Bundle;
    ...
    iget-object v2, p1, Landroid/support/v4/app/W$c;->q:[Ljava/lang/CharSequence;
    ...
    iget v1, p1, Landroid/support/v4/app/W$c;->J:I

    invoke-virtual {v0, v1}, Landroid/app/Notification$Builder;->setBadgeIconType(I)Landroid/app/Notification$Builder;

    move-result-object v0

    iget-object v1, p1, Landroid/support/v4/app/W$c;->K:Ljava/lang/String;

    invoke-virtual {v0, v1}, Landroid/app/Notification$Builder;->setShortcutId(Ljava/lang/String;)Landroid/app/Notification$Builder;

    move-result-object v0

    iget-wide v1, p1, Landroid/support/v4/app/W$c;->L:J

    invoke-virtual {v0, v1, v2}, Landroid/app/Notification$Builder;->setTimeoutAfter(J)Landroid/app/Notification$Builder;

    move-result-object v0

    iget v1, p1, Landroid/support/v4/app/W$c;->M:I

    invoke-virtual {v0, v1}, Landroid/app/Notification$Builder;->setGroupAlertBehavior(I)Landroid/app/Notification$Builder;

    iget-boolean v0, p1, Landroid/support/v4/app/W$c;->z:Z

    if-eqz v0, :cond_16

    iget-object v0, p0, Landroid/support/v4/app/X;->a:Landroid/app/Notification$Builder;

    iget-boolean v1, p1, Landroid/support/v4/app/W$c;->y:Z

    invoke-virtual {v0, v1}, Landroid/app/Notification$Builder;->setColorized(Z)Landroid/app/Notification$Builder;

    :cond_16
    iget-object p1, p1, Landroid/support/v4/app/W$c;->I:Ljava/lang/String;
    ...
    iget-object p1, p0, Landroid/support/v4/app/X;->a:Landroid/app/Notification$Builder;
...
.method private a(Landroid/support/v4/app/W$a;)V
    ...
    invoke-virtual {p1}, Landroid/support/v4/app/W$a;->e()I

    move-result v1

    invoke-virtual {p1}, Landroid/support/v4/app/W$a;->i()Ljava/lang/CharSequence;

    move-result-object v2

    invoke-virtual {p1}, Landroid/support/v4/app/W$a;->a()Landroid/app/PendingIntent;
    ...
    invoke-static {v1}, Landroid/support/v4/app/aa;->a([Landroid/support/v4/app/aa;)[Landroid/app/RemoteInput;
    ...
    :goto_1
    invoke-virtual {p1}, Landroid/support/v4/app/W$a;->b()Z
    ...
    :cond_2
    invoke-virtual {p1}, Landroid/support/v4/app/W$a;->g()I
    ...
    :cond_3
    invoke-virtual {p1}, Landroid/support/v4/app/W$a;->h()Z
...
.method public b()Landroid/app/Notification;
    ...
    iget-object v0, v0, Landroid/support/v4/app/W$c;->o:Landroid/support/v4/app/W$d;

    if-eqz v0, :cond_0

    invoke-virtual {v0, p0}, Landroid/support/v4/app/W$d;->a(Landroid/support/v4/app/V;)V

    :cond_0
    if-eqz v0, :cond_1

    invoke-virtual {v0, p0}, Landroid/support/v4/app/W$d;->c(Landroid/support/v4/app/V;)Landroid/widget/RemoteViews;
    ...
    :cond_2
    iget-object v1, p0, Landroid/support/v4/app/X;->b:Landroid/support/v4/app/W$c;

    iget-object v1, v1, Landroid/support/v4/app/W$c;->F:Landroid/widget/RemoteViews;
    ...
    invoke-virtual {v0, p0}, Landroid/support/v4/app/W$d;->b(Landroid/support/v4/app/V;)Landroid/widget/RemoteViews;
    ...
    iget-object v1, v1, Landroid/support/v4/app/W$c;->o:Landroid/support/v4/app/W$d;

    invoke-virtual {v1, p0}, Landroid/support/v4/app/W$d;->d(Landroid/support/v4/app/V;)Landroid/widget/RemoteViews;
    ...
    invoke-virtual {v0, v1}, Landroid/support/v4/app/W$d;->a(Landroid/os/Bundle;)V
...
.method protected c()Landroid/app/Notification;
    ...
    invoke-static {v0}, Landroid/support/v4/app/W;->a(Landroid/app/Notification;)Landroid/os/Bundle;
    ...
    iget-object v1, p0, Landroid/support/v4/app/X;->e:Ljava/util/List;

    invoke-static {v1}, Landroid/support/v4/app/Y;->a(Ljava/util/List;)Landroid/util/SparseArray;
